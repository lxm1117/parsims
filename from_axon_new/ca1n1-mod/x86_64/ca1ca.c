...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 8, 4);
 	...
 	ivoc_help("help ?1 ca1ca /home/ximi/Projects/ParSims/from_axon/ca1n1-mod/x86_64/ca1ca.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
 static double F = 96485.3;
static int _reset;
static char *modelname = "ca1ca.mod, calcium handling";
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   Dcai = - ica / depth / F / 2.0 * ( 1e7 ) - ( cai - cai0 ) / tau ;
   }
 return _reset;
}
...
static int scheme (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset=0; int error = 0;
 ...
 error = nrn_newton_thread(_newtonspace1, 1,_slist2, _p, scheme, _dlist2, _ppvar, _thread, _nt);
