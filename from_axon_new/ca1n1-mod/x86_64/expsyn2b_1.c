...
#define d d_expsyn2b_1
 extern double d( double );
 /* declare global and static user variables */
#define mg mg_expsyn2b_1
 double mg = 1.2;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 45, 3);
 pnt_receive[_mechtype] = _net_receive;
 pnt_receive_size[_mechtype] = 1;
 	hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 expsyn2b_1 /home/ximi/Projects/ParSims/from_axon/ca1n1-mod/x86_64/expsyn2b_1.mod\n");
...
static double _hoc_d(void* _vptr) {
 double _r;
    _hoc_setdata(_vptr);
 _r =  d (  *getarg(1) );
 return(_r);
