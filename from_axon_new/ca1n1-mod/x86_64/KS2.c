...
extern Memb_func* memb_func;
 ...
 "setdata_KS2", _hoc_setdata,
 "Boltz_m1_KS2", _hoc_Boltz_m1,
 "BorgMod_tau_KS2", _hoc_BorgMod_tau,
 "Boltzmann_KS2", _hoc_Boltzmann,
 "ngate_adjust_KS2", _hoc_ngate_adjust,
 "rates_KS2", _hoc_rates,
 0, 0
};
#define Boltz_m1 Boltz_m1_KS2
#define BorgMod_tau BorgMod_tau_KS2
#define Boltzmann Boltzmann_KS2
...
#define gates_h gates_h_KS2
 double gates_h = 1;
#define gates_n gates_n_KS2
 double gates_n = 4;
#define inf_h inf_h_KS2
 double inf_h = 0;
#define inf_n inf_n_KS2
 double inf_n = 0;
#define needAdj needAdj_KS2
 double needAdj = 1;
#define slope_h slope_h_KS2
 double slope_h = 8;
#define slp_adj slp_adj_KS2
 double slp_adj = 0;
#define slopeA_n slopeA_n_KS2
 double slopeA_n = 0;
#define slope_n slope_n_KS2
 double slope_n = -10;
#define tau0_h tau0_h_KS2
 double tau0_h = 0.01;
#define tauF_h tauF_h_KS2
 double tauF_h = 0;
#define tauG_h tauG_h_KS2
 double tauG_h = 0.5;
#define tauDv_h tauDv_h_KS2
 double tauDv_h = 0;
#define tauA_h tauA_h_KS2
 double tauA_h = 1000;
#define tau0_n tau0_n_KS2
 double tau0_n = 0.01;
#define tauF_n tauF_n_KS2
 double tauF_n = 0;
#define tauG_n tauG_n_KS2
 double tauG_n = 0.5;
#define tauDv_n tauDv_n_KS2
 double tauDv_n = 0;
#define tauA_n tauA_n_KS2
 double tauA_n = 100;
#define tau_h tau_h_KS2
 double tau_h = 0;
#define tau_n tau_n_KS2
 double tau_n = 0;
#define vhalfD_h vhalfD_h_KS2
 double vhalfD_h = 500;
#define v5_adj v5_adj_KS2
 double v5_adj = 0;
#define vhalfA_n vhalfA_n_KS2
 double vhalfA_n = 0;
#define vhalf_n vhalf_n_KS2
 double vhalf_n = -30;
 ...
 "gates_n_KS2", &gates_n_KS2,
 "vhalf_n_KS2", &vhalf_n_KS2,
 "slope_n_KS2", &slope_n_KS2,
 "needAdj_KS2", &needAdj_KS2,
 "vhalfA_n_KS2", &vhalfA_n_KS2,
 "slopeA_n_KS2", &slopeA_n_KS2,
 "v5_adj_KS2", &v5_adj_KS2,
 "slp_adj_KS2", &slp_adj_KS2,
 "tauA_n_KS2", &tauA_n_KS2,
 "tauDv_n_KS2", &tauDv_n_KS2,
 "tauG_n_KS2", &tauG_n_KS2,
 "tauF_n_KS2", &tauF_n_KS2,
 "tau0_n_KS2", &tau0_n_KS2,
 "gates_h_KS2", &gates_h_KS2,
 "vhalfD_h_KS2", &vhalfD_h_KS2,
 "slope_h_KS2", &slope_h_KS2,
 "tauA_h_KS2", &tauA_h_KS2,
 "tauDv_h_KS2", &tauDv_h_KS2,
 "tauG_h_KS2", &tauG_h_KS2,
 "tauF_h_KS2", &tauF_h_KS2,
 "tau0_h_KS2", &tau0_h_KS2,
 "inf_n_KS2", &inf_n_KS2,
 "tau_n_KS2", &tau_n_KS2,
 "inf_h_KS2", &inf_h_KS2,
 "tau_h_KS2", &tau_h_KS2,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 10, 4);
 	...
 	ivoc_help("help ?1 KS2 /home/ximi/Projects/ParSims/from_axon/ca1n1-mod/x86_64/KS2.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 65 in file KS2.mod:\n  SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
