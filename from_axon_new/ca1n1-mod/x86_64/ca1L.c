...
extern Memb_func* memb_func;
 ...
 "setdata_ca1L", _hoc_setdata,
 "rates_ca1L", _hoc_rates,
 "vtrap_ca1L", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_ca1L
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 13, 5);
 	...
 	ivoc_help("help ?1 ca1L /home/ximi/Projects/ParSims/from_axon/ca1n1-mod/x86_64/ca1L.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "ca1.mod Conductances for CA1 cells";
