...
extern Memb_func* memb_func;
 ...
 "setdata_KS1", _hoc_setdata,
 "Boltz_m1_KS1", _hoc_Boltz_m1,
 "BorgMod_tau_KS1", _hoc_BorgMod_tau,
 "Boltzmann_KS1", _hoc_Boltzmann,
 "ngate_adjust_KS1", _hoc_ngate_adjust,
 "rates_KS1", _hoc_rates,
 0, 0
};
#define Boltz_m1 Boltz_m1_KS1
#define BorgMod_tau BorgMod_tau_KS1
#define Boltzmann Boltzmann_KS1
...
#define gates_h gates_h_KS1
 double gates_h = 1;
#define gates_n gates_n_KS1
 double gates_n = 4;
#define inf_h inf_h_KS1
 double inf_h = 0;
#define inf_n inf_n_KS1
 double inf_n = 0;
#define needAdj needAdj_KS1
 double needAdj = 1;
#define slope_h slope_h_KS1
 double slope_h = 8;
#define slp_adj slp_adj_KS1
 double slp_adj = 0;
#define slopeA_n slopeA_n_KS1
 double slopeA_n = 0;
#define slope_n slope_n_KS1
 double slope_n = -10;
#define tau0_h tau0_h_KS1
 double tau0_h = 0.01;
#define tauF_h tauF_h_KS1
 double tauF_h = 0;
#define tauG_h tauG_h_KS1
 double tauG_h = 0.5;
#define tauDv_h tauDv_h_KS1
 double tauDv_h = 0;
#define tauA_h tauA_h_KS1
 double tauA_h = 1000;
#define tau0_n tau0_n_KS1
 double tau0_n = 0.01;
#define tauF_n tauF_n_KS1
 double tauF_n = 0;
#define tauG_n tauG_n_KS1
 double tauG_n = 0.5;
#define tauDv_n tauDv_n_KS1
 double tauDv_n = 0;
#define tauA_n tauA_n_KS1
 double tauA_n = 40;
#define tau_h tau_h_KS1
 double tau_h = 0;
#define tau_n tau_n_KS1
 double tau_n = 0;
#define vhalfD_h vhalfD_h_KS1
 double vhalfD_h = 500;
#define v5_adj v5_adj_KS1
 double v5_adj = 0;
#define vhalfA_n vhalfA_n_KS1
 double vhalfA_n = 0;
#define vhalf_n vhalf_n_KS1
 double vhalf_n = -30;
 ...
 "gates_n_KS1", &gates_n_KS1,
 "vhalf_n_KS1", &vhalf_n_KS1,
 "slope_n_KS1", &slope_n_KS1,
 "needAdj_KS1", &needAdj_KS1,
 "vhalfA_n_KS1", &vhalfA_n_KS1,
 "slopeA_n_KS1", &slopeA_n_KS1,
 "v5_adj_KS1", &v5_adj_KS1,
 "slp_adj_KS1", &slp_adj_KS1,
 "tauA_n_KS1", &tauA_n_KS1,
 "tauDv_n_KS1", &tauDv_n_KS1,
 "tauG_n_KS1", &tauG_n_KS1,
 "tauF_n_KS1", &tauF_n_KS1,
 "tau0_n_KS1", &tau0_n_KS1,
 "gates_h_KS1", &gates_h_KS1,
 "vhalfD_h_KS1", &vhalfD_h_KS1,
 "slope_h_KS1", &slope_h_KS1,
 "tauA_h_KS1", &tauA_h_KS1,
 "tauDv_h_KS1", &tauDv_h_KS1,
 "tauG_h_KS1", &tauG_h_KS1,
 "tauF_h_KS1", &tauF_h_KS1,
 "tau0_h_KS1", &tau0_h_KS1,
 "inf_n_KS1", &inf_n_KS1,
 "tau_n_KS1", &tau_n_KS1,
 "inf_h_KS1", &inf_h_KS1,
 "tau_h_KS1", &tau_h_KS1,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 10, 4);
 	...
 	ivoc_help("help ?1 KS1 /home/ximi/Projects/ParSims/from_axon/ca1n1-mod/x86_64/KS1.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 65 in file KS1.mod:\n  SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
