...
#define alpha_nmdar alpha_nmdar_expsyn2c_1
 double alpha_nmdar = 0.34;
#define alpha_ampar alpha_ampar_expsyn2c_1
 double alpha_ampar = 2;
#define beta_nmdar beta_nmdar_expsyn2c_1
 double beta_nmdar = 0.6;
#define beta_ampar beta_ampar_expsyn2c_1
 double beta_ampar = 2;
#define k_nmdar k_nmdar_expsyn2c_1
 double k_nmdar = 0.02;
#define k_ampar k_ampar_expsyn2c_1
 double k_ampar = 2;
#define mg mg_expsyn2c_1
 double mg = 1.2;
 ...
 "k_ampar_expsyn2c_1", "1/ms",
 "alpha_ampar_expsyn2c_1", "1/ms",
 "beta_ampar_expsyn2c_1", "1/ms",
 "k_nmdar_expsyn2c_1", "1/ms",
 "alpha_nmdar_expsyn2c_1", "1/ms",
 "beta_nmdar_expsyn2c_1", "1/ms",
 "scca", "uS",
 "sccn", "uS",
 "e", "mV",
 "i", "nA",
 ...
 "mg_expsyn2c_1", &mg_expsyn2c_1,
 "k_ampar_expsyn2c_1", &k_ampar_expsyn2c_1,
 "alpha_ampar_expsyn2c_1", &alpha_ampar_expsyn2c_1,
 "beta_ampar_expsyn2c_1", &beta_ampar_expsyn2c_1,
 "k_nmdar_expsyn2c_1", &k_nmdar_expsyn2c_1,
 "alpha_nmdar_expsyn2c_1", &alpha_nmdar_expsyn2c_1,
 "beta_nmdar_expsyn2c_1", &beta_nmdar_expsyn2c_1,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 115, 4);
 	hoc_register_cvode(_mechtype, _ode_count, _ode_map, _ode_spec, _ode_matsol);
 	hoc_register_tolerance(_mechtype, _hoc_state_tol, &_atollist);
 pnt_receive[_mechtype] = _net_receive;
 pnt_receive_size[_mechtype] = 1;
 	hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 expsyn2c_1 /home/ximi/Projects/ParSims/from_axon/ca1n1-mod/x86_64/expsyn2c_1.mod\n");
...
/*CVODE*/
 static int _ode_spec1 () {_reset=0;
 {
   ...
   Dnmdar_bound = - k_nmdar * nmdar_bound - beta_nmdar * nmdar_bound + ( alpha_nmdar / 2.0 ) * nmdar_active ;
 ...
 static int state () {_reset=0;
 {
    ...
    nmdar_bound = nmdar_bound + (1. - exp(dt*((- k_nmdar)*(1.0) - (beta_nmdar)*(1.0))))*(- ( (( ( alpha_nmdar ) / 2.0 ))*(nmdar_active) ) / ( (- k_nmdar)*(1.0) - (beta_nmdar)*(1.0) ) - nmdar_bound) ;
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 88 in file expsyn2c_1.mod:\n		SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
